		...
		<td>
			<table width="100%" align="center" >
				<tr>
					...
					<td>
						<input name="article.title" id="title" style="width:450px" class="easyui-validatebox textbox validatebox-text" />
					</td>
				</tr>
				<tr>
					<td style="padding-left:10px">作者</td>
					<td>
						<input name="article.author" id="author" style="width:450px" class="easyui-validatebox textbox validatebox-text"/>
					</td>
				</tr>
				<tr>
					<td style="padding-left:10px">转载地址（可不填）</td>
					<td>
						<input name="article.fromUrl" id="fromUrl" style="width:450px" class="easyui-validatebox textbox validatebox-text"/>
					</td>
				</tr>
				<tr>
					<td style="padding-left:10px">是否发布</td>
					<td>
						<input name="article.status" type="radio" value="1" checked="checked"/> 是
						<input name="article.status" type="radio" value="0" /> 否
					</td>
				</tr>
				<tr>
	...
	<tr >
		<td>
			<div width="100%" style="margin-left: 300px">
				<a href="javascript:void(0)" class="easyui-linkbutton" onclick="doSub()">发表</a>&nbsp;&nbsp;
