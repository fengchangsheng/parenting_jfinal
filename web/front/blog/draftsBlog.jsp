	...
	<div class="center-block-page clearfix">
		   <div class="tabs_header">
            <ul id="ul_tab" class="tabs">
                <li><a href="findMy"><span>已发表</span></a></li>
          		<li><a href="#" style="color: gray;"><span>草稿箱</span></a></li>
			...
			<c:forEach items="${myBlogs}"  var="blog" varStatus="i">
			    <c:if test="${i.index%2!=0}">
					<tr>
					     ...
					     <td><a href='toEdit?id=${blog.id}'>编辑</a> | <a href='rePost?id=${blog.id}'>发表</a> | <a href='recycle?id=${blog.id}' name=del>删除</a></td>
					 </tr>
			    </c:if>
			     <c:if test="${i.index%2==0}">
					 <tr class='altitem'>
					     ...
					     <td><a href='toEdit?id=${blog.id}'>编辑</a> | <a href='rePost?id=${blog.id}'>发表</a> | <a href='recycle?id=${blog.id}' name=del>删除</a></td></tr>
					 <tr>
				 </c:if>
			</c:forEach>
		</table>
