...
<body>
	<form id="configEdit" enctype="multipart/form-data" action="${basePath}/news/edit" method="post" >
		...
		<div title="广告信息" style="padding:10px;height:400px;" fit=true>
			<table width="90%">
				<tr>
					...
					<td><input name="news.title" data-options="required:true" style="width: 300px" value="${news.title}"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input name="news.module" type="text"  data-options="required:true" value="${news.module }"/>
					</td>
				</tr>
				<tr>
					<td height="45px">详情路径:</td>
					<td>
						<input name="news.link" type="text" value="${news.link}"  data-options="required:true" style="width: 300px"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<textarea name="news.shortCon" rows="5" style="width: 300px">${news.shortCon }</textarea>
					</td>
				</tr>
				<tr>
				<td colspan="2">
						<div >
						    <script id="editor" type="text/plain" style="width:800px;height:500px;">${news.content }</script>
						</div> 
					</td>
				</tr>
				<tr>
					...
					<td style="padding-top:20px;">
						 <div id="imgdiv"><img id="imgShow" width="600" height="300" src="${basePath}/imgUpload/newsImg/${news.imgPath}"/></div>
					</td>
				</tr>
				<tr>
